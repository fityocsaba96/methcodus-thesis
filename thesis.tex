...
\begin{document}
	...
	\chapter{Fejlesztői dokumentáció}
		...
		\section{Szerver architektúra}
			...
			TODO (mit tud, mire és hogyan használom: REST, Node.js, TypeScript, NestJS, TSLint, MongoDB, Docker, Ubuntu, Java, JavaScript, JUnit, Jasmine, Babel, Core.js, WebSocket, Socket.io, Passport, JWT)
        ...
        \begin{itemize}
          ...
          \item Elindítjuk az alkalmazást éles módban. A használandó portot és az adatbázis elérhetőségét előre beállított környezeti változókból kapjuk.
        \end{itemize}
