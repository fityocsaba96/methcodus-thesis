...
\begin{document}
		...
		\section{Szerver architektúra}
			...
			\subsection{Felhasznált technológiák}
				\subsubsection{Docker}
					A Docker \cite{docker} egy nyílt forráskódú konténerizációs platform. Docker segítségével a fejlesztők becsomagolhatják az alkalmazásaikat konténerekbe, amik olyan szabványosított futtatható komponensek, amelyek tartalmazzák az alkalmazás forráskódját az összes olyan operációs rendszeri könyvtárral és függőséggel együtt, amelyek szükségesek ahhoz, hogy a kód bármilyen környezetben futhasson. Bár ilyen konténereket létrehozni Docker nélkül is lehetséges, a Docker egyszerűbbé, könnyebbé és biztonságosabbá teszi a konténerek építését és kezelését. A konténerek operációs rendszeri folyamatizolációval és virtualizációval működnek, amelyek lehetővé teszik azt, hogy több alkalmazás komponens megossza egyetlen kernel erőforrásait. Ez nagyon hasonló elven működik, mint a virtuális gépeknél az erőforrások megosztása, viszont az operációs rendszer szintű absztrakciós rétegnek köszönhetően sokkal kisebb méretűek, az erőforrásokat hatékonyabban használják fel, illetve alkalmazásfejlesztésben egyszerűbben és gyorsabban felhasználhatóak.
	...
	\begin{thebibliography}{99}
		...
		\bibitem{docker}
			IBM: What is Docker?, \texttt{https://www.ibm.com/cloud/learn/docker} (2020.04.18.)
		\bibitem{nodejs}
			Nodejs.dev: Introduction to Node.js, \texttt{https://nodejs.dev} (2020.04.18.)
		\bibitem{typescript}
			TypeScript: What is TypeScript?, \texttt{https://www.typescriptlang.org} (2020.04.18.)
		\bibitem{nestjs}
			NestJS: Introduction, \texttt{https://docs.nestjs.com} (2020.04.18.)
		\bibitem{rest}
			Craig Buckler: An Introduction to REST and RESTful APIs, \texttt{https://www.sitepoint.com/developers-rest-api} (2020.04.18.)
		\bibitem{mongodb}
			MongoDB: What Is MongoDB?, \texttt{https://www.mongodb.com/what-is-mongodb} (2020.04.18.)
		\bibitem{test}
			TODO (kitölteni) \texttt{http://example.com} (2020.04.06.)
