...
\begin{document}
	...
	\begin{thebibliography}{99}
		...
		\bibitem{docker}
			IBM: What is Docker? (2020.04.18.)
			\\\texttt{https://www.ibm.com/cloud/learn/docker}
		\bibitem{nodejs}
			Nodejs.dev: Introduction to Node.js (2020.04.18.)
			\\\texttt{https://nodejs.dev}
		\bibitem{typescript}
		...
		\bibitem{rest}
			...
			\\\texttt{https://www.sitepoint.com/developers-rest-api}
		\bibitem{mongodb}
			MongoDB: What Is MongoDB? (2020.04.18.)
			\\\texttt{https://www.mongodb.com/what-is-mongodb}
		\bibitem{angular}
			Aman Goel: Why should you learn Angular? (2020.04.18.)
			\\\texttt{https://hackr.io/blog/why-should-you-learn-angular}
		\bibitem{spa}
			MDN: SPA (Single-page application) (2020.04.18.)
			\\\texttt{https://developer.mozilla.org/en-US/docs/Glossary/SPA}
		\bibitem{express}
			freeCodeCamp.org: ExpressJS (2020.04.18.)
			\\\texttt{https://guide.freecodecamp.org/nodejs/express}
		\bibitem{test}
